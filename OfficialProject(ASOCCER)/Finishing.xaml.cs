...
namespace OfficialProject_ASOCCER_
{
    ...
    /// </summary>
    public sealed partial class Finishing : Page
    {
        public Finishing()
        {
        ...
        private async void testSave(object sender, RoutedEventArgs e)
        {
            ...
            Windows.Storage.StorageFile myFile = await storageFolder.GetFileAsync("Comments1.txt");

            //appending the file
            await FileIO.AppendTextAsync(myFile, textUser);
            await FileIO.AppendTextAsync(myFile, text);
        }//end of testsave
